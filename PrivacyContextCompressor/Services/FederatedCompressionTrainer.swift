...
final class FederatedCompressionTrainer: ObservableObject {
    ...
    static let syntheticDeviceSamples: [CompressionSample] = [
        .init(workload: "Mail thread summary context", deviceClass: "iPhone Pro", errorBound: 0.001, compressionRatio: 8.9, latencyMS: 18, qualityLoss: 0.003, memoryMB: 220),
        .init(workload: "Notification priority context", deviceClass: "iPhone", errorBound: 0.002, compressionRatio: 10.8, latencyMS: 14, qualityLoss: 0.004, memoryMB: 160),
        .init(workload: "Notes semantic recall vectors", deviceClass: "iPad", errorBound: 0.001, compressionRatio: 7.4, latencyMS: 26, qualityLoss: 0.002, memoryMB: 310),
        .init(workload: "Photos memory understanding cache", deviceClass: "iPhone Pro", errorBound: 0.0005, compressionRatio: 5.2, latencyMS: 34, qualityLoss: 0.001, memoryMB: 620),
        .init(workload: "Health trend explanation context", deviceClass: "Apple Watch", errorBound: 0.003, compressionRatio: 12.4, latencyMS: 9, qualityLoss: 0.006, memoryMB: 80),
        .init(workload: "Siri intent personalization vectors", deviceClass: "iPhone", errorBound: 0.0015, compressionRatio: 9.7, latencyMS: 16, qualityLoss: 0.003, memoryMB: 140),
        .init(workload: "Calendar and reminders action context", deviceClass: "Mac", errorBound: 0.001, compressionRatio: 6.8, latencyMS: 21, qualityLoss: 0.002, memoryMB: 480),
        .init(workload: "Keyboard writing style context", deviceClass: "iPhone", errorBound: 0.004, compressionRatio: 13.1, latencyMS: 7, qualityLoss: 0.007, memoryMB: 60)
    ]
}
