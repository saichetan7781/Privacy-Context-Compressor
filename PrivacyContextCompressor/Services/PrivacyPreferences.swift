...
final class PrivacyPreferences: ObservableObject {
    ...
    var features: [PrivacyFeature] {
        [
            ...
            .init(
                title: "Sensitive context redaction",
                detail: "Personal context summaries hide potentially sensitive content before aggregation or export.",
            ...
            .init(
                title: "Export review",
                detail: "Shared context summaries require a deliberate review step before leaving the device.",
