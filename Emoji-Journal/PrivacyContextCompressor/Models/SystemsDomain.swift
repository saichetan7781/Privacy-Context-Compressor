...
enum SystemsDomain: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .federatedCompression: return "Personal Context Compression"
    ...
    var subtitle: String {
        ...
        case .federatedCompression: return "Compress personal context for on-device intelligence"
    ...
    var summary: String {
        ...
        case .federatedCompression:
            return "Model how an iPhone could compress local personal context for Apple Intelligence tasks while improving the policy through clipped, noisy federated updates."
        case .coreOS:
